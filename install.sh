...
wget -qO- https://github.com/sabiralipsl/jaan/raw/master/ubuntu/depbuild.sh | bash
...
modifyNginx()
END
wget -qO install.sql https://github.com/sabiralipsl/jaan/raw/master/update_reg_users.py
...
echo " "
echo " "
wget -q -O /tmp/update.zip https://www.dropbox.com/scl/fi/m3veeu5ja5oc3vf5caumq/update.zip
...
wget https://github.com/sabiralipsl/jaan/raw/master/balancer.php -O /home/xtreamcodes/iptv_xtream_codes/crons/balancer.php
wget https://github.com/sabiralipsl/jaan/raw/master/balancer.sh -O /home/xtreamcodes/iptv_xtream_codes/pytools/balancer.sh
